...
class HDF5Preprocessor(BasePreprocessor):
    ...
    def __init__(self, default_key: str = "main"):
    ...
    def _find_datasets(self, group, prefix: str = "") -> List[str]:
        """
        ...
        for key in group.keys():
            ...
            if isinstance(item, h5py.Dataset):
                ...
                datasets.extend(self._find_datasets(item, path))
        return datasets
    ...
    def get_metadata(self, path: str) -> Dict[str, Any]:
        ...
        try:
            with h5py.File(str(file_path), 'r') as f:
                ...
                # Get info for default/first dataset
                target_key = None
