...
class TIFFPreprocessor(BasePreprocessor):
    ...
    Example:
        ...
        >>> if preprocessor.validate("data.tiff"):
        ...     data = preprocessor.load("data.tiff")
    """
    ...
    def load(
        ...
        **kwargs,
        ...
        Returns:
            ...
            - Single page: (H, W) or (H, W, C) for RGB
            - Multi-page: (N, H, W) or (N, H, W, C)
            ...
            with tifffile.TiffFile(str(file_path)) as tif:
                ...
                if len(tif.pages) > 0:
                    ...
                    metadata.update({
                        ...
                        "photometric": str(page.photometric) if hasattr(page, 'photometric') else None,
                        "compression": str(page.compression) if hasattr(page, 'compression') else None,
                    })
        except Exception as e:
