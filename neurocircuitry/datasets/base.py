...
class BaseConnectomicsDataset(CacheDataset, Randomizable, ABC):
    """
    ...
    - resolution: Voxel/spatial resolution specification (dict or tuple)
    ...
    Example:
        >>> class MyDataset(BaseConnectomicsDataset):
        ...     @property
        ...     def paper(self) -> str:
    ...
    def paper(self) -> str:
        ...
        Example:
            >>> return "Kasthuri et al. (2015) Cell"
        """
    ...
    def labels(self) -> List[str]:
        ...
        Example:
            >>> return ["background", "neuron", "synapse"]
        """
        raise NotImplementedError
